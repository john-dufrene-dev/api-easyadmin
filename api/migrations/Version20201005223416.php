...
final class Version20201005223416 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE shop_info (uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', country VARCHAR(180) DEFAULT NULL, shop_hour LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', id INT AUTO_INCREMENT NOT NULL, UNIQUE INDEX UNIQ_A7BD72CBF396750 (id), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
